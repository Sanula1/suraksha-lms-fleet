                    ...
                    <div className="space-y-6">
                      <div className="relative">
                        ...
                        <div className="mt-2 relative">
                          ...
                          >
                            {passwordVisibility.currentPassword ? <EyeOff className="h-5 w-5" /> : <Eye className="h-5 w-5" />}
                          </button>
                        </div>
                      </div>
                      ...
                      <div className="relative">
                        ...
                        <div className="mt-2 relative">
                          ...
                          <button
                            ...
                            className="absolute right-3 top-1/2 transform -translate-y-1/2 text-muted-foreground hover:text-primary transition-colors p-1"
                          >
                            {passwordVisibility.newPassword ? <EyeOff className="h-5 w-5" /> : <Eye className="h-5 w-5" />}
                          </button>
                        </div>
                      ...
                      <div className="relative">
                        ...
                        <div className="mt-2 relative">
                          ...
                          <button
                            ...
                            className="absolute right-3 top-1/2 transform -translate-y-1/2 text-muted-foreground hover:text-primary transition-colors p-1"
                          >
                            {passwordVisibility.confirmPassword ? <EyeOff className="h-5 w-5" /> : <Eye className="h-5 w-5" />}
                          </button>
                        </div>
                      </div>
