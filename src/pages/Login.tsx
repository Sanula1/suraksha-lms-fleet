      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-hero relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-center p-12 text-primary-foreground">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h1 className="text-4xl font-bold">SurakshaLMS</h1>
          </div>
          <h2 className="text-2xl font-semibold mb-4">Transport Management System</h2>
          <p className="text-lg opacity-90 max-w-md">
            Secure, reliable, and efficient transport booking and management for students and institutions.
          </p>
        </div>
      </div>
